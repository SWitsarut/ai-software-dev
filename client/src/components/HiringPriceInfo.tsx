...
interface PricingInfoProps {
  ...
  const HiringPriceInfo: React.FC<PricingInfoProps> = ({ selectedLabels, dataPrice = 0 }) => {
    ...
    const finalPrice = totalLabelsPrice + dataPrice + 50;
      ...
      <Paper elevation={3} sx={{ p: 2, width: "100%" }}>
        ...
        <Box sx={{ mb: 2 }}>
          <Typography variant="body1" fontWeight="bold" sx={{ display: 'flex', justifyContent: 'space-between' }}>
            ...
            <span>{finalPrice} ฿ + Point Cost</span>
          </Typography>
  ...
  export default HiringPriceInfo;